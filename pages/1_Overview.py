...
with col2:
    st.markdown("""<div style="background:#f8f9fa;padding:20px;border-radius:10px;text-align:center;border-left:5px solid #27ae60;"><p style="color:#888;font-size:13px;margin:0;">Reduction Since 1985</p><h1 style="color:#27ae60;margin:5px 0;">{:.1f}%</h1><p style="color:#888;font-size:12px;margin:0;">global improvement</p></div>""".format(abs(pct_change)), unsafe_allow_html=True)
with col3:
    st.markdown("""<div style="background:#f8f9fa;padding:20px;border-radius:10px;text-align:center;border-left:5px solid #e74c3c;"><p style="color:#888;font-size:13px;margin:0;">Highest MMR (2023)</p><h1 style="color:#e74c3c;margin:5px 0;">{:.0f}</h1><p style="color:#888;font-size:12px;margin:0;">{}</p></div>""".format(highest["Value Numeric"], highest["Country"]), unsafe_allow_html=True)
with col4:
    st.markdown("""<div style="background:#f8f9fa;padding:20px;border-radius:10px;text-align:center;border-left:5px solid #2980b9;"><p style="color:#888;font-size:13px;margin:0;">Lowest MMR (2023)</p><h1 style="color:#2980b9;margin:5px 0;">{:.1f}</h1><p style="color:#888;font-size:12px;margin:0;">{}</p></div>""".format(lowest["Value Numeric"], lowest["Country"]), unsafe_allow_html=True)
with col5:
    st.markdown("""<div style="background:#f8f9fa;padding:20px;border-radius:10px;text-align:center;border-left:5px solid #8e44ad;"><p style="color:#888;font-size:13px;margin:0;">Countries Tracked</p><h1 style="color:#8e44ad;margin:5px 0;">{}</h1><p style="color:#888;font-size:12px;margin:0;">worldwide</p></div>""".format(total_countries), unsafe_allow_html=True)
