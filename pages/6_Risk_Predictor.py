...
st.markdown("Enter a patient's vitals below to predict their maternal health risk level.")

# --- MODEL ACCURACY ---
st.info(f"✅ Model Accuracy: **{accuracy*100:.1f}%** (Random Forest, 80/20 split)")
...
if st.button("🔍 Predict Risk Level"):
    ...
    fig = px.bar(prob_df, x="Risk Level", y="Probability",
                 color="Risk Level",
                 color_discrete_map={"Low Risk": "#2dc653", "Mid Risk": "#f4a261", "High Risk": "#e63946"},
...
fig2 = px.bar(importances, x="Importance", y="Feature", orientation="h",
              ...
              title="Which vitals matter most for predicting risk?")
