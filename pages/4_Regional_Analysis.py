...
fig2 = px.box(filtered, x="World bank income group", y="Value Numeric", color="World bank income group",
    title=f"MMR Distribution by Income Group ({selected_year})",
    labels={"Value Numeric": "MMR (per 100,000 live births)", "World bank income group": "Income Group"})
...
fig3 = px.line(region_trend, x="Year", y="Value Numeric", color="WHO region", title="MMR Trend by WHO Region (1985-2023)")
